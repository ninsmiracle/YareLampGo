...
[**下载 YareLampGo V2.0 完整 STEP 总成（73 MB）**](YareLampGo_V2.0/YareLampGo_V2.0_assembly.step)

这是可在 SolidWorks、Fusion 360、FreeCAD 等 CAD 软件中打开的完整装配文件，不是逐件 STL/3MF 打印包。

## 文件

| 文件 | 说明 |
| --- | --- |
| [YareLampGo_V2.0_assembly.step](YareLampGo_V2.0/YareLampGo_V2.0_assembly.step) | SolidWorks 2022 导出的 STEP AP214 完整总成，单位为毫米。 |
| `YareLampGo_V2.0/assembly-preview.png` | 从官方组装说明中提取的总成预览。 |
| [GitHub 网页版组装说明](../../docs/hardware/v2/YareLampGo_V2.0_assembly_manual.md) | 直接查看物料图片、紧固件位置、走线和装配顺序。 |
| [原始组装 DOCX](../../docs/hardware/v2/YareLampGo_V2.0_assembly_manual.docx) | 可下载、离线查看或打印的原始图文说明。 |
