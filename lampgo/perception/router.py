...
SKILL_KEYWORDS: dict[str, tuple[str, dict[str, Any] | None]] = {
    ...
    "idle": ("idle_sway", None),
    "sway": ("idle_sway", None),
    "害羞": ("set_expression", {"mode": "blush"}),
    "开心": ("set_expression", {"mode": "smiley"}),
    "难过": ("set_expression", {"mode": "crying"}),
    "生气": ("set_expression", {"mode": "angry"}),
    "惊讶": ("set_expression", {"mode": "surprised"}),
    "思考": ("set_expression", {"mode": "thinking"}),
    "爱心": ("set_expression", {"mode": "heart"}),
    "睡觉": ("set_expression", {"mode": "sleep"}),
    "彩虹": ("set_expression", {"mode": "rainbow"}),
}
