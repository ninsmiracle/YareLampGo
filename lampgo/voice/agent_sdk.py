...
class AgentSDKManager:
    ...
    def _can_start(self) -> bool:
        ...
        try:
            ...
            self._set_last_error("xiaomi-livekit-agent package is not installed")
            logger.warning(
    ...
    async def start(self) -> bool:
        ...
        if sdk_binary is None:
            self._set_last_error("xiaomi-livekit-agent CLI is missing from PATH and venv/bin")
            logger.warning(
        ...
        try:
            ...
            self._set_last_error("failed to start xiaomi-livekit-agent")
