...
Closely mirrors lelamp_runtime LeLampFollower — same bus.connect(),
sync_read, sync_write pattern that is proven to work on this hardware.
"""
...
class HardwareAbstraction:
    ...
    # ------------------------------------------------------------------
    # Read / Write — same as LeLampFollower.get_observation / send_action
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Calibration — same as LeLampFollower.calibrate()
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Internal — same as LeLampFollower.configure()
    # ------------------------------------------------------------------
