...
| [V2.0 组装说明（网页）](v2/YareLampGo_V2.0_assembly_manual.md) | 可直接在 GitHub 阅读的物料、线路、加工和组装图。 |
| [V2.0 组装说明（DOCX 下载）](v2/YareLampGo_V2.0_assembly_manual.docx) | 原始图文文件，适合离线查看或打印。 |
